...
const nonVerbalQuestions: Question[] = [
  {
    id: 'nv1',
    subject: 'non-verbal',
    text: 'Which shape comes next in this sequence?',
    options: ['Circle', 'Square', 'Triangle', 'Pentagon'],
    correctAnswer: 'Triangle',
    explanation: 'The pattern alternates between circle and square, then adds a side to each shape in the next cycle.',
    difficulty: 'medium'
  },
  {
    id: 'nv2',
    subject: 'non-verbal',
    text: 'If the pattern continues, which figure will replace the question mark?',
    options: ['A', 'B', 'C', 'D'],
    correctAnswer: 'B',
    explanation: 'The figures rotate 90 degrees clockwise with each step.',
    difficulty: 'easy'
  },
  {
    id: 'nv3',
    ...
    correctAnswer: 'Triangle',
    explanation: 'All shapes except Triangle have four sides.',
    difficulty: 'easy'
  },
  {
    id: 'nv4',
    ...
    explanation: 'The pattern involves alternating between black and white shapes, with the shapes growing in size.',
    difficulty: 'medium'
  },
  {
    id: 'nv5',
    subject: 'non-verbal',
    text: 'What comes next in this number sequence: 2, 4, 8, 16, __?',
    options: ['24', '32', '30', '20'],
    correctAnswer: '32',
  ...
  },
  {
    id: 'nv6',
    subject: 'non-verbal',
    text: 'Which figure is missing from the sequence?',
    options: ['Figure A', 'Figure B', 'Figure C', 'Figure D'],
    correctAnswer: 'Figure C',
    explanation: 'The sequence follows a pattern where the inner shape rotates 45 degrees clockwise while the outer shape alternates.',
    difficulty: 'hard'
  },
  {
    id: 'nv7',
    subject: 'non-verbal',
    text: 'Which image is the mirror reflection of the given image?',
    options: ['Image A', 'Image B', 'Image C', 'Image D'],
    correctAnswer: 'Image B',
    explanation: 'Image B shows the exact mirror reflection of the original image along the vertical axis.',
    difficulty: 'medium'
  },
  {
    id: 'nv8',
    subject: 'non-verbal',
    text: 'What comes next in this letter sequence: A, C, E, G, __?',
    options: ['H', 'I', 'J', 'K'],
    correctAnswer: 'I',
    explanation: 'The sequence shows every other letter in the alphabet: A, C, E, G, I.',
    difficulty: 'easy'
  },
  {
    id: 'nv9',
